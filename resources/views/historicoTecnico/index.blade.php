...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} - Histórico de Técnicos</title>
                ...
                <div class="container mx-auto">
                    <caption class="text-2xl font-bold p-4 text-gray-700">
                        <div class="section-title">
                            <i class="bi bi-clock-history"></i><i class="bi bi-person-badge-fill"></i> Histórico de Técnicos
                        </div>
                    </caption>
                        ...
                        <tfoot>
                            <tr>
                                <th scope="row" colspan="3" class="text-left p-4 bg-gray-200">
                                    <a href="{{ url('/historicoTecnico/create') }}" class="text-blue-600 hover:underline font-medium">
