...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} - Gerenciamento de Categorias</title>
                ...
                <div class="container mx-auto">
                    <caption class="text-2xl font-bold p-4 text-gray-700">
                        <div class="section-title">
                            <i class="bi bi-collection"></i> Categorias
                        </div>
                    </caption>
                        ...
                        <tbody>
                            @foreach($categorias as $categoria)
                                <tr class="hover:bg-gray-100">
                                    <td class="border border-gray-300 px-4 py-2">{{ $categoria->nome }}</td>
                                    <td class="border border-gray-300 px-4 py-2">{{ $categoria->descricao }}</td>
                                    <td class="border border-gray-300 px-4 py-2">
                                        <a href="{{ route('categoria.edit', $categoria->id) }}" class="text-blue-600 hover:underline">
                        ...
                        <tfoot>
                            <tr>
                                <th scope="row" colspan="3" class="text-left p-4 bg-gray-200">
                                    <a href="{{ url('/categoria/create') }}" class="text-blue-600 hover:underline font-medium">
                                        <i class="bi bi-plus-lg font-bold"></i> Inserir Categoria
                                    </a>
                                </th>
                            </tr>
                        </tfoot>
