...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} - Histórico de Chamados</title>
                ...
                <div class="container mx-auto">
                    <caption class="text-2xl font-bold p-4 text-gray-700">
                        <div class="section-title">
                            <i class="bi bi-clock-history"></i> <i class="bi bi-card-checklist"></i>  Histórico de Chamados
                        </div>
                    </caption>
                    <table class="table-auto border-collapse border border-gray-300 w-full text-sm shadow-lg rounded-lg overflow-hidden bg-white">
                        <thead class="bg-gray-200 text-gray-800 rounded-t-lg">
                            <tr>
                                ...
                                <th scope="col" class="border border-gray-300 px-4 py-2">Chamado</th>
                        ...
                        <tbody>
                            @foreach($historicoChamados as $historico)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">{{ $historico->id_chamado }}</td>
                                    <td class="border border-gray-300 px-4 py-2">
                                        <a href="{{ route('historicoChamado.edit', $historico->id) }}" class="text-blue-600 hover:underline">
                        ...
                        <tfoot>
                            <tr>
                                <th scope="row" colspan="3" class="text-left p-4 bg-gray-200">
                                    <a href="{{ url('/historicoChamado/create') }}" class="text-blue-600 hover:underline font-medium">
